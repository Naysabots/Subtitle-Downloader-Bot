...
def start(client,message):
    kb = [[InlineKeyboardButton('Channel 🛡', url="https://t.me/Tellybots"),InlineKeyboardButton('Support Group 🔰', url="https://t.me/Tellybots_Support")]]
    reply_markup = InlineKeyboardMarkup(kb)
    app.send_message(chat_id=message.from_user.id, text=f"Hello there, I am a **Subtitle Downloader Bot**.\nGive me a Movie/Series name and I will fetch it from **Subscene**.\n\n"
                                                        "__**Developer :**__ __@Tellybots__\n"
...
def help(client,message):
    url = [[InlineKeyboardButton(f"Update", url=f"https://t.me/tellybots")],
           [InlineKeyboardButton(f"Support", url=f"t.me/tellybots_support")]]
    ...
    f" * `Search for it on `Subscene.com`\n"
    f" * `Let you choose your preferable language.\n`"
    f" * `Download the subtitle, unzip and upload in `.srt/.ass` format`", parse_mode='md', reply_markup=reply_markup)
